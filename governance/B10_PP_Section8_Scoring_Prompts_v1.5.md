...
## Changes from v1.4: Score 1 label changed from "Inaccurate" to "Insufficient" in both Prompt 1 and Prompt 2 — aligns with speaking prompt rating system; construct rationale: topic-only responses are insufficient, not inaccurate
...
- "score_label" must exactly match the score: 1 = "Insufficient" · 2 = "Partial" · 3 = "Good" · 4 = "Excellent"
...
*B10-PP Section 8 Scoring Prompts v1.5 — DLIELC — Jeff Moore — April 23, 2026*
