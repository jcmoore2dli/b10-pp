    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div>
          ...
          <p className="text-blue-200 text-xs">Task: {isEso ? 'Extended Supported Opinion' : passage.layer === 'EXT' ? 'Extended Listening' : passage.layer === 'NAR' ? 'Past Tense Narration' : passage.layer === 'DES' ? 'Description' : passage.layer === 'INS' ? 'Instructions' : 'Oral Paraphrase'}</p>
        </div>
      </header>
      ...
      <main className="px-4 py-6 max-w-lg mx-auto flex flex-col gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-3">{(['ESO','NAR','DES','INS'].includes(passage.layer) && passage.question) ? passage.question : passage.domain}</h2>
